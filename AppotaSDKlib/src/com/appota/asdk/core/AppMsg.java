...
public class AppMsg {
    ...
    public static final int LENGTH_INFO = 6000;
	 ...
	 */
	public static final Style STYLE_INFO = new Style(LENGTH_INFO, R.drawable.style_info_selector);
	 ...
	 * 
	 */
    public static AppMsg makeText(Activity context, CharSequence text, Style style, View.OnClickListener onClick) {
	 ...
	 */
	public static AppMsg makeText(Activity context, int resId, Style style, View.OnClickListener onClick)
			throws Resources.NotFoundException {
		return makeText(context, context.getResources().getText(resId), style, onClick);
	}
